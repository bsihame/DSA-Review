...
console.log("Array to string method => arr.toString() it change the array to a string");

const fruits = ["Banana", "Orange", "Apple", "Mango"];
console.log(fruits.toString());

const fruitsToStr = fruits.toString()
console.log(typeof fruitsToStr);
//=======================================================
console.log("Join method");
console.log("Join method joins all array elements into a string");

const vegetables = ["Potatoes", "Tomatoes", "turnips", "Quince"];
console.log(vegetables.join(" * ")); // Potatoes * Tomatoes * turnips * Quince
console.log(vegetables.join(" -->")); // Potatoes -->Tomatoes -->turnips -->Quince

console.log(typeof vegetables.join(" -->")) // string
//=========================================================
console.log("Pop method");
console.log("arr.pop method remove the last element in the array");

const moroccoCities = ["Casablanca", "Fez", "Marrakech", "Rabat"];
moroccoCities.pop(); //  remove rabat
console.log(moroccoCities)
//============================================================
console.log("Push method");
console.log("arr.push() push method add the element in the end of the array")

const myShoppingList = ["Banana", "Orange", "Apple", "Mango"];
myShoppingList.push("Milk");
console.log(myShoppingList)
//============================================================
console.log("Shift method");
console.log("arr.Shift() remove element in the front of the array")

const myShoppingList2 = ["Banana", "Orange", "Apple", "Mango"];
console.log(2, myShoppingList2.shift(""))
myShoppingList2.shift("");
console.log(myShoppingList2)
//========================================================================
...
// console.log(basket.unshift("Lemon"));// thin give the length of the array
console.log(2, basket)

//=======================================================================

console.log("Delete element");

const removeOneFruit = ["Banana", "Orange", "Apple", "Mango"];
delete removeOneFruit[2]//[ 'Banana', 'Orange', <1 empty item>, 'Mango' ]
delete removeOneFruit[0]//[ <1 empty item>, 'Orange', 'Apple', 'Mango' ]

console.log(removeOneFruit)//
